package weblab.webproject4.security;
...
import weblab.webproject4.security.jwt.AuthEntryPointJwt;
import weblab.webproject4.security.jwt.AuthTokenFilterJwt;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors()
                ...
                .authorizeRequests()
                .antMatchers("/webproject4/api/auth/**").permitAll()
